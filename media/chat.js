(function () {
  ...
  function renderAboutPanel(check) {
    ...
    addGearItem(
      `<span class="popover-gh">${ghIcon} lxiaolong068/grok-vscode</span><span class="popover-external">↗</span>`,
      () => { vscode.postMessage({ type: "openUrl", url: "https://github.com/lxiaolong068/grok-vscode" }); closePopovers(); },
    );
  }
