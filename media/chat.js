(function () {
  ...
  function renderAboutPanel(check) {
    ...
    addGearItem(
      `<span class="popover-gh">${ghIcon} hiliqi/grok-vscode</span><span class="popover-external">↗</span>`,
      () => { vscode.postMessage({ type: "openUrl", url: "https://github.com/hiliqi/grok-vscode" }); closePopovers(); },
    );
  }
